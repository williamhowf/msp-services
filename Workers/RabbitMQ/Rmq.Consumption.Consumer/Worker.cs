...
using Rmq.Core.Services.Consumption.Consumer;
using Rmq.Core.Settings;

namespace Rmq.Consumption.Consumer
{
    public class Worker : BackgroundService
    {
        ...
        protected override Task ExecuteAsync(CancellationToken stoppingToken)
        {
            ...
            {
                SingletonLogger.Info("Consumption " + rabbitType + "[" + i + "] trying to connect to RabbitMQ...");
                ...
                var consumer = new RmqConsumptionConsumer(rabbitType + "[" + i + "]", rmqConnection, rabbitConfig);
                CommUtil.PrintLoggerConnection("Consumption " + rabbitType + "[" + i + "]", rmqConnection);
