...
using Rmq.Core.Services.OpenMarket.Producer;
using Rmq.Core.Settings;

namespace Rmq.OpenMarket.Producer
{
    public class Worker : BackgroundService    //clement 20200821 MDT-1583
    {
        ...
        protected override Task ExecuteAsync(CancellationToken stoppingToken)
        {
            ...
            SingletonLogger.Info("Megopoly CashIn " + rabbitType + " trying to connect to RabbitMQ...");
            ...
            var producer = new RmqOpenMarketProducer(rmqConnection, rabbitConfig);

            serviceWorkerTask = Task.Run(() => producer.Run(stoppingToken), stoppingToken);
            CommUtil.PrintLoggerConnection("Megopoly CashIn " + rabbitType, rmqConnection);
