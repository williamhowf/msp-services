...
using Rmq.Core.Services.PersonalReward.Consumer;
...
namespace Rmq.PersonalReward.Consumer
{
    public class Worker : BackgroundService   //clement 20200816 MDT-1580
    {
        ...
        protected override Task ExecuteAsync(CancellationToken stoppingToken)
        {
            ...
            {
                SingletonLogger.Info("Personal Reward " + rabbitType + "[" + i + "] trying to connect to RabbitMQ...");
                ...
                var consumer = new RmqPersonalRewardConsumer(rabbitType + "[" + i + "]", rmqConnection, rabbitConfig);
                CommUtil.PrintLoggerConnection("Personal Reward " + rabbitType + "[" + i + "]", rmqConnection);
